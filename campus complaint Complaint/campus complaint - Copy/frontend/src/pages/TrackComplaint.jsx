...
export default function TrackComplaint() {
  ...
  const fetchComplaint = async (searchToken) => {
    ...
    setError(null);
    try {
      const res = await axios.get(`${API_URL}/api/complaints/track/${searchToken}`);
  ...
  const handleReply = async (e) => {
    ...
    try {
      const res = await axios.post(`${API_URL}/api/complaints/track/${searchToken}/reply`, {
        content: newReply
      });
      setComplaint(res.data);
      setNewReply('');
  ...
  const handleReviewAction = async (resolution) => {
    try {
      const res = await axios.post(`${API_URL}/api/complaints/track/${searchToken}/review`, { resolution });
      setComplaint(res.data);
    } catch (err) {
