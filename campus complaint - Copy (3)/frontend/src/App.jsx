          ...
          <div className="max-w-6xl mx-auto flex justify-between items-center">
            ...
            <nav className="flex gap-6 items-center">
              ...
              {!(localStorage.getItem('token') || sessionStorage.getItem('token')) ? (
                <>
                  <Link to="/login" className="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 font-medium ml-4">Student Login</Link>
                ...
                <>
                  <Link to="/public-complaints" className="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 font-medium border-l dark:border-gray-600 pl-6 ml-2">All Complaints</Link>
                  <Link to="/profile" className="text-gray-800 dark:text-gray-200 font-bold hover:text-blue-600 dark:hover:text-blue-400 transition ml-4">My Profile</Link>
